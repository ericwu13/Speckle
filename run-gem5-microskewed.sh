...
GEM5_OPTIONS="--l1d_size=32kB --l1d_assoc=8 --l1i_size=32kB --l1i_assoc=8 --caches --mem-size=8192MB --tags=microskewed"
...
if [[ $suite_type == "intspeed" ]]; then
    BENCHMARKS=(602.gcc 605.mcf 623.xalancbmk 625.x264 631.deepsjeng 641.leela 657.xz)
