...
GEM5_OPTIONS="--l1d_size=32kB --l1d_assoc=8 --l1i_size=32kB --l1i_assoc=8 --caches --mem-size=8192MB --tags=microtag"
...
if [[ $suite_type == "intspeed" ]]; then
    ...
    # BENCHMARKS=(603.bwaves 607.cactuBSSN 619.lbm 621.wrf 627.cam4 628.pop2 638.imagick 644.nab 649.fotonik3d 654.roms)
    BENCHMARKS=(628.pop2 654.roms)
else
    # BENCHMARKS=(503.bwaves 507.cactuBSSN 508.namd 510.parest 511.povray 519.lbm 521.wrf 526.blender 527.cam4 538.imagick 544.nab 549.fotonik3d 554.roms)
    BENCHMARKS=(511.povray)
fi
